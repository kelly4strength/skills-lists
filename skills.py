...
def print_indexes(my_list):
    ...
    print "Nothing at all"  #return [n for n in number_list if n%2 == 0]
    #print [i for i in my_list[] " i  " '\n']
...
def largest_int(number_list):
    ...
    """
    #return [n for n in number_list if n > n+1]
    return 0
...
def join_strings(word_list):
    ...
    """
    #I want to strip the spaces and concatenate the strings into one...
    return [str(word_list).strip([', '])]
...
def reverse_list_in_place(my_list):
    ...
    return my_list[::-1] #NOT CORRECT - What does without creating a new list mean? 
